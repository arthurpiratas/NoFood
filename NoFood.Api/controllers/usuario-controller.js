...
usuarioController.prototype.post = async (req, res) =>{
    ...
    let usuarioIsEmailExiste = await _repo.IsEmailExite((req.body.email).toLowerCase())
...
usuarioController.prototype.put = async (req, res) =>{
    ...
    if (usuarioIsEmailExiste) {
        _validationContract.isTrue(
            (usuarioIsEmailExiste.nome != undefined) && (usuarioIsEmailExiste._id != req.params.id), `Já existe o e-mail ${req.body.email} cadastrado em nossa base.`)
    }
